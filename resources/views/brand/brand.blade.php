...
<body>
 <h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;商品信息添加表</h2></hr>
<form class="form-horizontal" role="form" action="{{url('/tj')}}" method="post" enctype="multipart/form-data">
@csrf
    ...
    <div class="form-group">
        ...
        <div class="col-sm-2">
            <input type="text" class="form-control" id="firstname" name="num">
        </div>
    </div>
     ...
     <div class="form-group">
        ...
        <div class="col-sm-2">
            <input type="radio" id="firstname" value="1" name="is_jp" checked>是
            <input type="radio" id="firstname" value="2" name="is_jp" >否
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-2">
            <input type="radio" id="firstname" value="1" name="is_rx"checked>是
            <input type="radio" id="firstname" value="2" name="is_rx" >否
        </div>
    </div>
